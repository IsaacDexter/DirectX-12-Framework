...
public:
	...
	*/
	Texture(const D3D12_CPU_DESCRIPTOR_HANDLE& srvCpuDescriptorHandle, const D3D12_GPU_DESCRIPTOR_HANDLE& srvGpuDescriptorHandle, const UINT& srvRootParameterIndex);
	/**
